...
function ShoppingList() {
    ...
    const currentShoppingList = shoppingList.map( ingredient => <tr><td>{ingredient.ingredient.measure} {ingredient.ingredient.ingredient}</td><td><button className="table-button"><i className="fas fa-trash-alt"></i></button></td></tr> );
