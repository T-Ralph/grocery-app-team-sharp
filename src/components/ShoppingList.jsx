...
function ShoppingList() {
    ...
    const currentShoppingList = shoppingList.map( ingredient => <tr key={ingredient.id}><td>{ingredient.ingredient.measure} {ingredient.ingredient.ingredient} ({ingredient.ingredient.meal})</td><td><button className="table-button"><i className="fas fa-trash-alt"></i></button></td></tr> );
