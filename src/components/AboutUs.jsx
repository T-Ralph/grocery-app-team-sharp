            ...
            <main>
                <section className="main-section">
                    ...
                    <div className="team-member">
                        ...
                        <span class = "team-member-name">Lindsey Graham </span> Born in Edmonton, Alberta, Lindsey spent the early years of his professional life in the Oil & Gas sector, doing jobs ranging from Purchasing, to onsite work as an Electrician. </p>
                        ...
                        <p className="team-member-text">
                        <span class = "team-member-name"> Krisztina Pap</span>Krisztina is hard-at-work turning her passion for programming into a career. She has a strong background in training, project management, and tech. When she's not writing code, she enjoys reading fantasy novels, jogging, and playing board games with her family.
                        </p>
                    </div>
                    <div className="team-member">
                        <img className="team-member-img" src={Tosin} alt="Tosin Olaniyi" />
                        <p className="team-member-text">
                        <span class = "team-member-name"> Tosin Olaniyi</span>Tosin is a Pharmacist by Profession and Programmer by Passion.Tosin has keen interest in using technology and data science to improve the processes and systems used in the health sector.
                        </p>
                    </div>
                    <div className="team-member">
                        <img className="team-member-img" src={Tarun} alt="Tarun Mulle" />
                        <p className="team-member-text">
                        <span class = "team-member-name"> Tarun Mulle</span>Tarun is born in India and made Canada his home. He is enthusiastic professional who is aspiring to start a new career with the Tech sector and hoping to solve societal problems using technology. A few of his interests include public speaking, human psychology and yoga.
                        </p>
                    </div>
                    <h2>
                        <i className="fas fa-scroll"></i>
